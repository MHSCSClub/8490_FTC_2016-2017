...
@Autonomous(name="TigerScout: Auto Drive RED", group="TigerScout")
public class TigerScoutAutoDriveRed_Linear extends TigerScoutAutoDriveBeacon_Linear {
    @Override
    int TURN_DIRECTION() {
        return 1;
    }
